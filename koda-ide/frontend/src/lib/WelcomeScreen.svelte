<script>
  ...
  let { sdk = { ok: false, lines: [] }, onNewProject, onOpenWorkspace, onOpenHelp = () => {} } = $props()
  ...
  const templates = [
    ...
    },
    {
      id: 'graphics',
      title: 'Bouncing ball',
      blurb: 'Raylib window with @game — press F5 to run.',
    },
    {
      id: 'pong',
      title: 'Pong',
...
<div class="welcome">
  <header>
    ...
    <p class="welcome-lead">
      Unzip the Koda SDK for your OS, pick a template or open a folder, then press
