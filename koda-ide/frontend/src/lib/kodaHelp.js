...
export const KODA_KEYWORDS = [
  ...
  ['include', 'Include another .koda file (#include).', '#include "@game"'],
  ...
  ['this', 'Current instance in methods.', 'this.health = 100;'],
...
export const KODA_STDLIB_MODULES = [
  ['@math', 'Math helpers (sqrt, sin, lerp, …).', 'let math = import "@math";'],
  ['@io', 'File read/write helpers.', 'let io = import "@io";'],
  ['@json', 'JSON parse/stringify.', 'let json = import "@json";'],
  ['@array', 'Array utilities (range, sum, shuffle).', 'let arr = import "@array";'],
  ['@str', 'String utilities.', 'let str = import "@str";'],
  ['@util', 'General utilities.', 'let util = import "@util";'],
  ['@game', 'Raylib game API (graphics projects).', '#include "@game"'],
  ['@color', 'Color constants and helpers.', 'let color = import "@color";'],
  ['@vec2', '2D vector math.', 'let vec2 = import "@vec2";'],
  ['@vec3', '3D vector math.', 'let vec3 = import "@vec3";'],
  ['@timer', 'Timers and scheduling.', 'let timer = import "@timer";'],
  ['@easing', 'Easing functions for animation.', 'let ease = import "@easing";'],
  ['@noise', 'Procedural noise.', 'let noise = import "@noise";'],
  ['@input', 'Input helpers.', 'let input = import "@input";'],
  ['@pool', 'Object pooling.', 'let pool = import "@pool";'],
]
